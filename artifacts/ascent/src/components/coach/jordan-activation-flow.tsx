...
export function JordanActivationFlow({ onComplete }: { onComplete: () => void }) {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="max-w-lg w-full space-y-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-xs text-muted-foreground uppercase tracking-widest font-medium">Operations Coach</span>
        </div>
          ...
          <div className="space-y-5 animate-in fade-in duration-500">
            ...
            <div className="flex gap-3">
              <Input
                ...
                className="max-w-xs"
                autoFocus
                onKeyDown={(e) => { if (e.key === "Enter" && coachName.trim()) save({ coachName: coachName.trim() }, "style"); }}
              />
              <Button
        ...
        {step === "walkthrough" && (
          <div className="space-y-5 animate-in fade-in duration-500">
            ...
            <p className="text-base text-muted-foreground">Want me to walk you through it?</p>
            <Button
              size="lg"
